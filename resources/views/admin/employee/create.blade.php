                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 col-lg-4 col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="phone" class="form-control" id="phone" placeholder="+63" autocomplete="off" data-mask="0000-000-000">
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-6 col-sm-12">
                       <div class="form-group">
                        ...
                        <input type="text" name="rate_per_hour" class="form-control" id="rate_per_hour" placeholder="" autocomplete="off">
                      ...
                      <div class="col-md-6 col-lg-6 col-sm-12">
                       <div class="form-group">
                        ...
                        <input type="text" name="salary" class="form-control" id="salary" placeholder="" autocomplete="off">
