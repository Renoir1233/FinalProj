...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Payslips {{ $date }} | SurePay. </title>
    <style type="text/css">
      body {
          position: relative;
          width: auto;  
  ...
  <body>
    <div class="card border-1">
          <div class="card-header">
              <h2 class="text-center border-top-bootom-1 py-4">SurePay - EMPLOYEE PAYMENT SLIPS</h2>
                  ...
                  <div class="col-12 table-responsive">
                    <table cellspacing="0" cellpadding="3" class="table">  
                        ...
                        <tr> 
                            ...
                            <td width="25%" align="right">{{ number_format($payroll->calculateSSS($payroll->gross_amount),2) }}</td> 
                        </tr>
                        <tr> 
                            <td></td> 
                            <td></td>
                            <td width="25%" align="right">PhilHealth: </td>
                            <td width="25%" align="right">{{ number_format($payroll->gross_amount * 0.0275,2) }}</td> 
                        </tr>
                        <tr> 
                            <td></td> 
                            <td></td>
                            <td width="25%" align="right">Pag-IBIG: </td>
                            <td width="25%" align="right">{{ number_format($payroll->gross_amount * 0.02,2) }}</td> 
                        </tr>
                        <tr> 
                            <td></td> 
                            <td></td>
                            <td width="25%" align="right">Tax: </td>
                            <td width="25%" align="right">{{ number_format($payroll->calculateTax($payroll->gross_amount),2) }}</td> 
                        </tr>
                        <tr> 
                            <td></td> 
                            <td></td>
                        ...
                        <tr> 
                            <td></td> 
                            <td></td>
                            <td width="25%" align="right"><b>Total Deductions:</b></td>
                            <td width="25%" align="right"><b>{{ number_format($payroll->deductions,2) }}</b></td> 
                        </tr>
                        <tr> 
                            <td></td> 
                            <td></td>
                            <td width="25%" align="right"><b>Net Pay:</b></td>
                            <td width="25%" align="right"><b>{{ number_format($payroll->net_pay,2) }}</b></td> 
                        </tr>
                    </table><hr>
                  </div>
                </div>
