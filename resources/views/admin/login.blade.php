...
@section('title') Login | SurePay Payroll System  @endsection
...
<div style="text-align: center;">
    <img src="{{ asset('admin_assets/img/paysure.png') }}" alt="SurePay" style="width:350px; height:170px;">
</div>
<h3>Sign In to SurePay System</h3>
<p>Welcome Back!</p>
