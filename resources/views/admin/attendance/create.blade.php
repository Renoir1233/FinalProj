  ...
  <div class="row align-items-end">
    <div class="col-lg-8">
      <div class="page-header-title">
        ...
        <div class="d-inline">
          <h5>Attendance</h5>
          <span>Create Attendance, Please fill all fields correctly.</span>
        </div>
      </div>
    </div>
    <div class="col-lg-4">
      ...
      <div class="widget-body">
        ...
        <form action="{{ $form_store }}" method="POST" enctype="multipart/form-data" id="createAttendance">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="form-group">
                <label for="employee_id">Employee <small class="text-danger">*</small></label>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="time_in">Time In <small class="text-danger">*</small></label>
          ...
          <div class="form-group mt-3">
            ...
            <a href="{{ route('admin.attendance.index') }}" class="btn btn-light">
              <i class="ik ik-arrow-left"></i> Go Back
            </a>
          </div>
        </form>
      </div>
