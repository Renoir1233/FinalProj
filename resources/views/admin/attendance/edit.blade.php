  ...
  <div class="row align-items-end">
    <div class="col-lg-8">
      <div class="page-header-title">
        ...
        <div class="d-inline">
          <h5>Attendance</h5>
          <span>Edit Attendance. Please fill all fields correctly.</span>
        </div>
      </div>
    </div>
    <div class="col-lg-4">
    ...
    <div class="widget overflow-visible">
      ...
      <div class="widget-body">
        <div class="overlay hidden">
          ...
          <span class="overlay-text">Updating Attendance...</span>
        </div>
          ...
          <div class="row">
                ...
                <select class="form-control" name="employee_id" id="employee_id">
                  @foreach($employees as $employee)
                    <option value="{{ $employee->id }}"
                      @if($employee->id == $attendance->employee_id) selected @endif>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control datetimepicker-input" name="date" id="date" data-toggle="datetimepicker" data-target="#date" autocomplete="off" data-value="{{ $attendance->date }}">
          ...
          <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control datetimepicker-input" id="time_in" name="time_in" data-toggle="datetimepicker" data-target="#time_in" data-value="{{ $attendance->time_in }}">
            ...
            <div class="col-md-6 col-lg-6 col-sm-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control datetimepicker-input" id="time_out" name="time_out" data-toggle="datetimepicker" data-target="#time_out" data-value="{{ $attendance->time_out }}">
          ...
          <div class="row">
            <div class="col-md-12">
              <p class="text-warning small">
                *If the employee checks in within a 30-minute interval, it will be counted as <b>OnTime</b>. Otherwise, it will be considered a <b>Late</b> check-in.
              </p>
              <button type="submit" class="btn btn-primary"><i class="ik ik-save"></i> Submit</button>
              <a href="{{ route('admin.attendance.index') }}" class="btn btn-light"><i class="ik ik-arrow-left"></i> Go Back</a>
            </div>
          </div>
        </form>
      </div>
...
$(document).ready(function() {
  ...
  $('#time_in').datetimepicker({
    format: 'LT',
    defaultDate: moment(time_in, "HH:mm:ss")
  });

  $('#time_out').datetimepicker({
    format: 'LT',
    defaultDate: moment(time_out, "HH:mm:ss")
  });
