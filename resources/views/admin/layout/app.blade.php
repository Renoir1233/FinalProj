...
<html class="no-js" lang="en">
    <head>
        ...
        <title>@yield('title') | SurePay - A System for HR Payment Generator.</title>
        ...
        <div class="wrapper">
            <header class="header-top" header-theme="light">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="top-menu d-flex align-items-center">
                            <div class="">
                                <span class="text-secondary mr-2" style="color: white !important;">Hi, {{ Auth::user()->username }}</span>
                            </div>
                            <div class="dropdown">
            ...
            <div class="page-wrap">
                <div class="app-sidebar colored">
                    <div class="sidebar-header" style="background-color: #e67e22;">
                        <a class="header-brand" href="{{ url('/') }}">
                            <div class="logo-img">
                               <img src="{{ asset('./admin_assets/tile_192.png') }}" width="32">
                            </div>
                            <small class="text pl-2"><b>SurePay</b></small>
